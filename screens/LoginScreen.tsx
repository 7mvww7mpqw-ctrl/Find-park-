        ...
        <div className="h-full w-full bg-white flex flex-col p-8 animate-fade-in">
            <div className="flex-1 flex flex-col items-center justify-center">
                ...
                <div className="w-full space-y-4">
                    <div className="bg-gray-50 border border-gray-100 rounded-2xl px-4 py-3 flex items-center">
                        ...
                        <input 
                            ...
                            className="flex-1 bg-transparent outline-none text-right dir-rtl font-medium text-gray-800"
                        />
                    </div>

                    <button 
                        onClick={() => setScreen(ScreenState.HOME)}
                        className="w-full bg-blue-600 text-white py-4 rounded-2xl font-bold text-lg shadow-xl shadow-blue-600/20 active:scale-95 transition-all flex items-center justify-center gap-2"
                    >
                        <span>دخول</span>
                        <ArrowLeft size={20} />
                    </button>
                ...
                <div className="flex gap-4 mt-8 w-full">
                    <button className="flex-1 border border-gray-200 py-3 rounded-2xl flex items-center justify-center hover:bg-gray-50 transition-colors">
