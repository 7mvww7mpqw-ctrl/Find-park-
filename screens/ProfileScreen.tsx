...
import { User, Award, History, CreditCard, Star } from 'lucide-react';
        ...
        <div className="h-full w-full bg-gray-50 overflow-y-auto pb-24 p-6">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-3xl p-6 text-white shadow-xl mb-6 relative overflow-hidden">
                ...
                <div className="flex justify-between items-center bg-white/10 rounded-2xl p-4 backdrop-blur-sm">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-xl font-bold flex items-center gap-1">ذهبي <Award size={16} className="text-yellow-400" /></p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 mb-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <div className="bg-gray-100 p-3 rounded-xl"><CreditCard size={24} className="text-gray-600" /></div>
                    <div>
            ...
            <div className="space-y-3">
                {[1, 2, 3].map((i) => (
                    <div key={i} className="bg-white rounded-2xl p-4 shadow-sm border border-gray-100 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <div className="bg-green-50 p-2 rounded-lg"><History size={20} className="text-green-600" /></div>
                            <div>
                        ...
                        <div className="flex flex-col items-end">
                            ...
                            <div className="flex text-yellow-400 mt-1"><Star size={10} fill="currentColor" /><Star size={10} fill="currentColor" /><Star size={10} fill="currentColor" /><Star size={10} fill="currentColor" /><Star size={10} fill="currentColor" /></div>
                        </div>
                    </div>
                ))}
            </div>
            <button className="w-full mt-8 border border-red-100 text-red-500 py-3 rounded-xl font-medium hover:bg-red-50 transition-colors">تسجيل الخروج</button>
        </div>
    );
};
